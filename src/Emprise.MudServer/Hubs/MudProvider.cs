...
namespace Emprise.MudServer.Hubs
{
    public class MudProvider: IMudProvider
    {
        ...
        public async Task ShowFightingSkill(int playerId, object obj)
        {
            await _context.Clients.User(playerId.ToString()).SendAsync("ShowFightingSkill", obj);
        }
        ...
        public async Task ShowNpcSkill(int playerId, object obj)
        {
            await _context.Clients.User(playerId.ToString()).SendAsync("ShowNpcSkill", obj);
        }
        ...
        public async Task ShowShop(int playerId, object obj)
        {
