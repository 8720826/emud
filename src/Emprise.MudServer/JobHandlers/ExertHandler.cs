...
{
    public class ExertHandler : IExertHandler
    {
        ...
        public ExertHandler(IMudProvider mudProvider, IPlayerDomainService playerDomainService, ILogger<MeditateHandler> logger, IRecurringQueue recurringQueue, IMediatorHandler bus)
        {
