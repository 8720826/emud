...
namespace Emprise.Domain.Core.Interfaces
{
    public interface IMudProvider: IScoped
    {
        ...
        Task ShowMySkill(int playerId, object obj);

        Task ShowFightingSkill(int playerId, object obj);
        ...
        Task ShowWare(int playerId, object obj);

        Task DropWare(int playerId, object obj);
